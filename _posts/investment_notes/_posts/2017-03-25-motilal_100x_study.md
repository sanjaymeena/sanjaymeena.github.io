...
layout: single
title: The SQGLP (Size, Quality, Growth, Longevity, Price) Framework for identifying multibagger stocks.
published: true
categories: [Investing]
tags: [investment-notes]
sitemap: true
excerpt: We discuss the SQGLP (Size, Quality, Growth, Longevity, Price) Framework for identifying multibagger stocks. 
description: We discuss the SQGLP (Size, Quality, Growth, Longevity, Price) Framework for identifying multibagger stocks. 
...
The low base effect plays a crucial role in the big returns. 
...
1. Global Value Migration e.g. global manufacturing value migrating to China; value in IT and health-care sectors migrating to India, etc
...
1. Macro Sector Level
		* When aggregate demand in any sector exceeds aggregate capacity. It creates a "supply squeeze" , causing end product prices to soar. This drives up company products. 
2. Company Level
